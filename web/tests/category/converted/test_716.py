...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.common.apiClientSession.startCurrentApiClientSession()
            parentId = self.common.apiClientSession.getParentId('galleries') 
            if self.common.apiClientSession.createCategory(parentId, localSettings.LOCAL_SETTINGS_LOGIN_USERNAME, self.restrictedCategoryName, self.description, self.tags) == False:
                self.status = "Fail"
            ...
            self.common.apiClientSession.startCurrentApiClientSession()
            parentId = self.common.apiClientSession.getParentId('galleries') 
            if self.common.apiClientSession.createCategory(parentId, localSettings.LOCAL_SETTINGS_LOGIN_USERNAME, self.privateCategoryName, self.description, self.tags) == False:
                self.status = "Fail"
