...
class Test:
    ...
    # Test Name : eSearch - Fields display in results - Multiple - channel - pending tab
    # Test description:
    # Upload entries with different cue points fields
    # Go to channel page - pending tab , make a search that matches multiple values in field, and check for field display in results
    #    1. Name
    #    2. Description
    #    3. Tag
    #    4. Details 
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 3: Going to make a search in channel - pending tab that matches multiple captions")
            if self.common.channel.makeSearchInPending(self.searchInMultipleCaptions) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 3: FAILED to make a search in channel - pending tab that matches multiple captions")
                return   
            ...
            writeToLog("INFO","Step 8: Going to make a search in channel - pending tab that matches multiple tags")
            if self.common.channel.makeSearchInPending(self.searchInMultipleTags) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 8: FAILED to make a search in channel - pending tab that matches multiple tags")
                return   
            ...
            writeToLog("INFO","Step 13: Going to make a search in channel - pending tab that matches multiple quiz")
            if self.common.channel.makeSearchInPending(self.searchInMultipleQuiz) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 13: FAILED to make a search in channel - pending tab that matches multiple quiz")
                return   
            ...
            writeToLog("INFO","Step 23: Going to make a search in channel - pending tab that matches multiple chapters")
            if self.common.channel.makeSearchInPending(self.searchInMultipleChapters) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 23: FAILED to make a search in My channel - pending tab that matches multiple chapters")
                return   
            ...
            writeToLog("INFO","Step 28: Going to make a search in channel - pending tab that matches multiple comments")
            if self.common.channel.makeSearchInPending(self.searchInMultipleComments) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 28: FAILED to make a search in channel - pending tab that matches multiple comments")
                return   
            ...
            writeToLog("INFO","Step 33: Going to make a search in channel - pending tab that matches multiple polls")
            if self.common.channel.makeSearchInPending(self.searchInMultiplePolls) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 33: FAILED to make a search in channel - pending tab that matches multiple polls")
                return   
            ...
            writeToLog("INFO","Step 38: Going to make a search in channel - pending tab that matches multiple details")
            if self.common.channel.makeSearchInPending(self.searchInMultipleDetails) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 38: FAILED to make a search in channel - pending tab that matches multiple details")
                return   
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: verify multiple field values display in channel - pending tab done successfully")
