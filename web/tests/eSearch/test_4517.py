...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - with search - Channel page - media tab - negative and positive
    # Test description:
    ...
    searchPage = "Channel Page - media tab - with search"
...
# SINGLE LIST NEGATIVE
            ...
            if self.common.globalSearch.verifyFiltersInGlobalPage(self.listInvalid) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.globalSearch.verifyFiltersInGlobalPage(self.singleListMap[entry][0]) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.globalSearch.verifyFiltersInGlobalPage(self.singleTextMap[entry]) == False:
                    self.status = "Fail"
...
#                 if self.common.globalSearch.verifyFiltersInGlobalPage(self.singleDateMap[entry]) == False:
#                     self.status = "Fail"
