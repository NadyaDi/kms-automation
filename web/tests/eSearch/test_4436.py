...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : eSearch - Search in entry page - Video 
    # Test description:
    ...
    entryName = "Fields display - All Fields - multiple - video"
    tagName = "Tags"
    slidesName = "Slides"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO", "Step 8: Verify that the search results for " + self.captionsName + "are properly displayed while using show less/all/more option")
            if self.common.entryPage.verifyFieldDisplayInEntryPageAfterMakingASearch(self.captionsName, enums.EntryFields.CAPTIONS, 7) == False:
                self.status = "Fail"
                writeToLog("INFO", "Step 8: Failed, the search results for" + self.captionsName + "are not properly displayed while using show less/all/more option")
                return                                                                   
            ##################################################################
