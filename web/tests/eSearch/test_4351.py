...
class Test:
    ...
    # Test Name : eSearch - Search In - Gallery - media tab
    # Test description:
    # Upload entries with different cue points fields
    # Go Gallery page, media tab, make a search, and filter entries by 'Search in' drop down:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInGallery) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifySearchInDropDownState(False) == False:
                ...
                return              
            ##################################################################
            writeToLog("INFO","TEST PASSED: Search in gallery - media tab done successfully")
