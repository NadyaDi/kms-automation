...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - no search - Category page - media tab - negative and positive
    # Test description:
...
# SINGLE LIST NEGATIVE
            ...
            if self.common.channel.verifyEntriesDisplay(self.listInvalid) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.channel.verifyEntriesDisplay(self.singleListMap[entry][0]) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.channel.verifyEntriesDisplay(self.singleTextMap[entry]) == False:
                    self.status = "Fail"
...
#                 if self.common.channel.verifyEntriesDisplay(self.singleDateMap[entry]) == False:
#                     self.status = "Fail"
