...
class Test:
    ...
    # Test Name : eSearch - Sort by - Add to gallery - My media tab - when search is made
    # Test description:
    # Upload entries with different sort by values
    # Go to Add to gallery page, my media tab, make a search and make the next sorts (with and without search):
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: Sort by in 'Add to gallery - My Media tab' - when search is made was done successfully")
