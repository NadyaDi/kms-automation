...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - with search - Channel page - pending tab - negative and positive
    # Test description:
    ...
    searchPage = "Channel Page - pending tab - with search"
...
# SINGLE LIST NEGATIVE
            ...
            if self.common.channel.verifyFiltersInPendingTab(self.listInvalid) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.channel.verifyFiltersInPendingTab(self.singleListMap[entry][0]) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.channel.verifyFiltersInPendingTab(self.singleTextMap[entry]) == False:
                    self.status = "Fail"
...
#                 if self.common.channel.verifyFiltersInPendingTab(self.singleDateMap[entry]) == False:
#                     self.status = "Fail"
