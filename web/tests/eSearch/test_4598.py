...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - with search - co editor - Add new quiz
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.secondtype, enums.Ownership.ANY_OWNER.value, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, True], self.enumMediaEdit:[self.secondtype, enums.Ownership.MEDIA_EDIT.value, False]}
