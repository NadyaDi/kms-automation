...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - with search - media owner - Channel Page
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.listAnyOwner, enums.Ownership.ANY_OWNER.value, False], self.enumMediaOwn:[self.listAnyOwner, enums.Ownership.MEDIA_OWN.value, False], self.enumMediaEdit:[self.listAllInvalid, enums.Ownership.MEDIA_EDIT.value, True], self.enumMediaPublish:[self.listAllInvalid, enums.Ownership.MEDIA_PUBLISH.value, True]}
