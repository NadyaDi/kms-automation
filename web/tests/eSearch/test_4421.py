...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 3: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple caption values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleCaptions, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 3: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple caption values")
                return   
            ...
            writeToLog("INFO","Step 8: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple tags values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleTags, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 8: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple tags values")
                return
            ...
            writeToLog("INFO","Step 13: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple quiz values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleQuiz, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 13: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple quiz values")
                return 
            ...
            writeToLog("INFO","Step 18: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple slide values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleSlides, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 18: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple slide values")
                return             
            ...
            writeToLog("INFO","Step 23: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple chapter values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleChapters, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 23: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple chapter values")
                return
            ...
            writeToLog("INFO","Step 28: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple comments values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleComments, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 28: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple comments values")
                return
            ...
            writeToLog("INFO","Step 33: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple polls values")
            if self.common.channel.searchInAddToChannel(self.searchInMultiplePolls, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 33: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple polls values")
                return   
            ...
            writeToLog("INFO","Step 38: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple details values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleDetails, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 38: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple details values")
                return  
