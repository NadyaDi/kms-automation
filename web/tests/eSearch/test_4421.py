...
class Test:
    ...
    # Test Name : eSearch - Fields display in results - Multiple - Add to gallery - SR tab
    # Test description:
    # Upload entries with different cue points fields
    # Go to Add to gallery - SR tab, make a search that matches multiple values in field, and check for field display in results
    #    1. Name
    #    2. Description
    #    3. Tag
    #    4. Details 
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 4: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple caption values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleCaptions, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 4: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple caption values")
                return   
            ...
            writeToLog("INFO","Step 9: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple tags values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleTags, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 9: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple tags values")
                return
            ...
            writeToLog("INFO","Step 14: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple quiz values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleQuiz, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 14: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple quiz values")
                return 
            ...
            writeToLog("INFO","Step 19: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple slide values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleSlides, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 19: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple slide values")
                return             
            ...
            writeToLog("INFO","Step 24: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple chapter values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleChapters, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 24: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple chapter values")
                return
            ...
            writeToLog("INFO","Step 29: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple comments values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleComments, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 29: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple comments values")
                return
            ...
            writeToLog("INFO","Step 34: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple polls values")
            if self.common.channel.searchInAddToChannel(self.searchInMultiplePolls, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 34: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple polls values")
                return   
            ...
            writeToLog("INFO","Step 39: Going to make a search in 'Add to gallery' - 'SR' tab that matches multiple details values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleDetails, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 39: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches multiple details values")
                return  
            ...
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(False, enums.EntryFields.DETAILS, numOfDisplay=self.detailsNumOfDisplay) == False:
                ...
                return                                                                                                                         
            ##################################################################
            writeToLog("INFO","TEST PASSED: verify multiple field values display in 'Add to gallery - SR tab' done successfully")
