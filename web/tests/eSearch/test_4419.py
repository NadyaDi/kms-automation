...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 2: Going to make a search in 'Add to gallery - My media' tab that matches multiple caption values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleCaptions) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 2: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple caption values")
                return   
            ...
            writeToLog("INFO","Step 7: Going to make a search in 'Add to gallery - My media' tab that matches multiple tags values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleTags) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 7: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple tags values")
                return
            ...
            writeToLog("INFO","Step 12: Going to make a search in 'Add to gallery - My media' tab that matches multiple quiz values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleQuiz) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 12: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple quiz values")
                return 
            ...
            writeToLog("INFO","Step 17: Going to make a search in 'Add to gallery - My media' tab that matches multiple slide values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleSlides) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 17: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple slide values")
                return             
            ...
            writeToLog("INFO","Step 22: Going to make a search in 'Add to gallery - My media' tab that matches multiple chapter values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleChapters) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 22: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple chapter values")
                return
            ...
            writeToLog("INFO","Step 27: Going to make a search in 'Add to gallery - My media' tab that matches multiple comments values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleComments) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 27: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple comments values")
                return
            ...
            writeToLog("INFO","Step 32: Going to make a search in 'Add to gallery - My media' tab that matches multiple polls values")
            if self.common.channel.searchInAddToChannel(self.searchInMultiplePolls) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 32: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple polls values")
                return   
            ...
            writeToLog("INFO","Step 37: Going to make a search in 'Add to gallery - My media' tab that matches multiple details values")
            if self.common.channel.searchInAddToChannel(self.searchInMultipleDetails) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 37: FAILED to make a search in 'Add to gallery - My media' tab that matches multiple details values")
                return  
