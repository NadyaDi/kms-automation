...
class Test:
    ...
    # Test Name : eSearch - Sort by - Add new quiz - when search is made
    # Test description:
    # Upload entries with different sort by values
    # Go to add new quiz page, make a search and sort entries (Sort is done when there search is made and when there is no search) :
