...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - with search - co publisher and co editor - Channel Page
    # Test description:
    ...
    searchPage = "Channel Page - with search"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.listAnyOwner, enums.Ownership.ANY_OWNER.value, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, True], self.enumMediaEdit:[self.fourthtype, enums.Ownership.MEDIA_EDIT.value, False], self.enumMediaPublish:[self.fourthtype, enums.Ownership.MEDIA_PUBLISH.value, False]}
            ...
            for entry in self.entriesMap:
                ...
                if self.common.globalSearch.verifyFiltersInGlobalPage(self.entriesMap[entry][0], self.entriesMap[entry][2]) == False:
                    self.status = "Fail"
