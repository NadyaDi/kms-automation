...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - with search - My Media - negative and positive
    # Test description:
    ...
    searchPage = "My Media Page - with search"
...
# SINGLE LIST NEGATIVE
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.listInvalid) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.myMedia.verifyFiltersInMyMedia(self.singleListMap[entry][0]) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.myMedia.verifyFiltersInMyMedia(self.singleTextMap[entry]) == False:
                    self.status = "Fail"
...
#                 if self.common.myMedia.verifyFiltersInMyMedia(self.singleDateMap[entry]) == False:
#                     self.status = "Fail"
