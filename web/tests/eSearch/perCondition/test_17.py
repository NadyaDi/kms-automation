...
class Test:
    ...
    # Test description:
    # Upload three Video entries and filter them by scheduling in: Past, Future and In Scheduling
    #================================================================================================================================
    testNum = "17"
    ...
    entryName1 = "Filter by Scheduling - Video future"
    entryName2 = "Filter by Scheduling - Video past"
    entryName3 = "Filter by Scheduling - Video In Scheduling"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 6: Going to publish the " + self.entryName2 +"  entry")
            if self.common.myMedia.publishSingleEntry(self.entryName2, [self.categoryForModerator, self.categoryForEsearch], [self.channelForEsearch, self.SrChannelForEsearch, self.channelForModerator], publishFrom = enums.Location.MY_MEDIA) == False:
                writeToLog("INFO","Step 6: FAILED to publish the " + self.entryName2 +"  entry")
                return
            ...
            writeToLog("INFO","Step 9: Going to publish the " + self.entryName3 +"  entry")
            if self.common.myMedia.publishSingleEntry(self.entryName3, [self.categoryForModerator, self.categoryForEsearch], [self.channelForEsearch, self.SrChannelForEsearch, self.channelForModerator], publishFrom = enums.Location.MY_MEDIA) == False:
                writeToLog("INFO","Step 9: FAILED to publish the " + self.entryName3 +"  entry")
                return
