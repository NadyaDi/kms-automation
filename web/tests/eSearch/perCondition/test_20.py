...
class Test:
    ...
    # Test description:
    # Upload three Image entries and filter them by scheduling in: Past, Future and In Scheduling
    #================================================================================================================================
    testNum = "20"
    ...
    entryName1 = "Filter by Scheduling - Image future"
    entryName2 = "Filter by Scheduling - Image past"
    entryName3 = "Filter by Scheduling - Image In Scheduling"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","TEST PASSED: All the image entries were properly created with Scheduling conditions and published successfully")
            #################################################################################
