...
class Test:
    ...
    # Test description:
    # Going to upload six type of entries (video, quiz, audio, image, webcast and youtube)
    # Going to leave the entries without any co-editor nor co-publisher
    #================================================================================================================================
    testNum = "29"
    ...
    common = None
    # Test variables
    entryNameVideo      = "Filter by Ownership - firstype Video"
    entryNameQuiz       = "Filter by Ownership - firstype Quiz"
    entryNameAudio      = "Filter by Ownership - firstype Audio"
    entryNameImage      = "Filter by Ownership - firstype Image"
    entryNameYoutube    = "Filter by Ownership - firstype Youtube"
    entryNameWebCast    = "Filter by Ownership - firstype Webcast"
    publishNameQuiz     = "Filter by Ownership - firstype Quiz - Quiz"
