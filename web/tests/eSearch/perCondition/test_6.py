...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy2, '', '', self.newTag)== False:
                self.status = "Fail"
            ...
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy3, '', '', self.newTag)== False:
                self.status = "Fail"
            ...
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy8, '', '', self.newTag)== False:
                self.status = "Fail"
            ...
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy1, '', '', self.newTag)== False:
                self.status = "Fail"
            ...
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy5, '', '', self.newTag)== False:
                self.status = "Fail"
            ...
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy4, '', '', self.newTag)== False:
                self.status = "Fail"
            ...
            writeToLog("INFO","Step 15: Going to update: " + self.entryForSortBy6)            
            if self.common.editEntryPage.changeEntryMetadata(self.entryForSortBy6, '', '', self.newTag)== False:
                self.status = "Fail"
                writeToLog("INFO","Step 15: FAILED to update: " + self.entryForSortBy6)
                return                                                            
