...
class Test:
    ...
    # Test description:
    # Upload three Audio entries and filter them by publish statuses: private, unlisted, published, rejected and pending
    ...
    entryName1 = "Filter by Status - Audio Private"
    entryName2 = "Filter by Status - Audio Unlisted"
    entryName3 = "Filter by Status - Audio Multiple"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","TEST PASSED: All the Audio entries were successfully created with proper publish statuses")
            #################################################################################
