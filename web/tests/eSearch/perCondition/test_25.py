...
class Test:
    ...
    # Test description:
    # Upload a Video entry, publish it and insert custom data: a new text line, two unlimited, a list and a custom date
    #================================================================================================================================
    testNum = "25"
    ...
    userPass1 = "Kaltura1!"
    entryName1 = "Filter by custom-data - Video"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.singleTextCustomdataFieldInput1 = "Filter by custom-data - Video Single Text"
            self.unlimitedTextCustomdataField1 = "UnlimitedText0"
            self.unlimitedTextCustomdataFieldInput1 = ["Filter by custom-data - Video unlimited one", "Filter by custom-data - Video unlimited two"]
            ...
            self.dateCustomDataFieldDate = '1'
            ...
            writeToLog("INFO","TEST PASSED: The video entry for Filter by custom data has been successfully created with all the custom data")
            #################################################################################
