...
class Test:
    ...
    # Test description:
    # Upload three Image entries and filter them by publish statuses: private, unlisted, published, rejected and pending
    ...
    entryName1 = "Filter by Status - Image Private"
    entryName2 = "Filter by Status - Image Unlisted"
    entryName3 = "Filter by Status - Image Multiple"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","TEST PASSED: All the Image entries were successfully created with proper publish statuses")
            #################################################################################
