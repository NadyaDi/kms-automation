...
class Test:
    ...
    # Test description:
    # Upload a Audio entry, publish it and insert custom data: a new text line, two unlimited, a list and a custom date
    #================================================================================================================================
    testNum = "27"
    ...
    userPass1 = "Kaltura1!"
    entryName1 = "Filter by custom-data - Audio"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.singleTextCustomdataFieldInput1 = "Filter by custom-data - Audio Single Text"
            self.unlimitedTextCustomdataField1 = "UnlimitedText0"
            self.unlimitedTextCustomdataFieldInput1 = ["Filter by custom-data - Audio unlimited one", "Filter by custom-data - Audio unlimited two"]
            self.unlimitedTextCustomdataAddField = "UnlimitedText"
            self.ListCustomdataField1 = "SingleTextSelectedList"
            self.ListCustomdataFieldOption1 = "Search in - Four"
            self.dateCustomDataField = "SIngleDate"
            self.dateCustomDataFieldYear = '2018'
            self.dateCustomDataFieldMonth = 'May'
            self.dateCustomDataFieldDate = '4'
            ...
            writeToLog("INFO","TEST PASSED: The Audio entry for Filter by custom data has been successfully created with all the custom data")
            #################################################################################
