...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - with search - co publisher and co editor - Add new quiz - with search
    # Test description:
    ...
    searchPage = "Add new quiz - with search"
    filterMenuName = "Filter by Ownership"
    userType = "Co Publisher and Co Editor"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.listAnyOwner    = {self.firstypeVideo: True, self.firstypeQuiz: False, self.firstypeAudio: True, self.firstypeImage: False, self.firstypeYoutube: True, self.firstypeWebcast: False, self.secondtypeVideo: True, self.secondtypeQuiz: False, self.secondtypeAudio: True, self.secondtypeImage: False, self.secondtypeYoutube: True, self.secondtypeWebcast: False, self.thirdtypeVideo: True, self.thirdtypeQuiz: False, self.thirdtypeAudio: True, self.thirdtypeImage: False, self.thirdtypeYoutube: True, self.thirdtypeWebcast: False, self.fourthtypeVideo: True, self.fourthtypeQuiz: False, self.fourthtypeAudio: True, self.fourthtypeImage: False, self.fourthtypeYoutube: True, self.fourthtypeWebcast: False}
            ...
            self.firstype        = {self.firstypeVideo: True, self.firstypeQuiz: False, self.firstypeAudio: True, self.firstypeImage: False, self.firstypeYoutube: True, self.firstypeWebcast: False, self.secondtypeVideo: False, self.secondtypeQuiz: False, self.secondtypeAudio: False, self.secondtypeImage: False, self.secondtypeYoutube: False, self.secondtypeWebcast: False, self.thirdtypeVideo: False, self.thirdtypeQuiz: False, self.thirdtypeAudio: False, self.thirdtypeImage: False, self.thirdtypeYoutube: False, self.thirdtypeWebcast: False, self.fourthtypeVideo: False, self.fourthtypeQuiz: False, self.fourthtypeAudio: False, self.fourthtypeImage: False, self.fourthtypeYoutube: False, self.fourthtypeWebcast: False}
            self.secondtype      = {self.firstypeVideo: False, self.firstypeQuiz: False, self.firstypeAudio: False, self.firstypeImage: False, self.firstypeYoutube: False, self.firstypeWebcast: False, self.secondtypeVideo: True, self.secondtypeQuiz: False, self.secondtypeAudio: True, self.secondtypeImage: False, self.secondtypeYoutube: True, self.secondtypeWebcast: False, self.thirdtypeVideo: False, self.thirdtypeQuiz: False, self.thirdtypeAudio: False, self.thirdtypeImage: False, self.thirdtypeYoutube: False, self.thirdtypeWebcast: False, self.fourthtypeVideo: False, self.fourthtypeQuiz: False, self.fourthtypeAudio: False, self.fourthtypeImage: False, self.fourthtypeYoutube: False, self.fourthtypeWebcast: False}
            self.thirdtype       = {self.firstypeVideo: False, self.firstypeQuiz: False, self.firstypeAudio: False, self.firstypeImage: False, self.firstypeYoutube: False, self.firstypeWebcast: False, self.secondtypeVideo: False, self.secondtypeQuiz: False, self.secondtypeAudio: False, self.secondtypeImage: False, self.secondtypeYoutube: False, self.secondtypeWebcast: False, self.thirdtypeVideo: True, self.thirdtypeQuiz: False, self.thirdtypeAudio: True, self.thirdtypeImage: False, self.thirdtypeYoutube: True, self.thirdtypeWebcast: False, self.fourthtypeVideo: False, self.fourthtypeQuiz: False, self.fourthtypeAudio: False, self.fourthtypeImage: False, self.fourthtypeYoutube: False, self.fourthtypeWebcast: False}
            self.fourthtype      = {self.firstypeVideo: False, self.firstypeQuiz: False, self.firstypeAudio: False, self.firstypeImage: False, self.firstypeYoutube: False, self.firstypeWebcast: False, self.secondtypeVideo: False, self.secondtypeQuiz: False, self.secondtypeAudio: False, self.secondtypeImage: False, self.secondtypeYoutube: False, self.secondtypeWebcast: False, self.thirdtypeVideo: False, self.thirdtypeQuiz: False, self.thirdtypeAudio: False, self.thirdtypeImage: False, self.thirdtypeYoutube: False, self.thirdtypeWebcast: False, self.fourthtypeVideo: True, self.fourthtypeQuiz: False, self.fourthtypeAudio: True, self.fourthtypeImage: False, self.fourthtypeYoutube: True, self.fourthtypeWebcast: False}
            ...
            self.entriesMap = {self.enumAnyOwner:[self.fourthtype, enums.Ownership.ANY_OWNER.value, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, True], self.enumMediaEdit:[self.fourthtype, enums.Ownership.MEDIA_EDIT.value, False]}
            ...
            for entry in self.entriesMap:
                ...
                if self.common.kea.verifyFiltersInAddQuizPage(self.entriesMap[entry][0], self.entriesMap[entry][2]) == False:
                    self.status = "Fail"
