...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 2: Going to make a search in 'Add to channel' - 'My Media' tab that matches entry name")
            if self.common.channel.searchInAddToChannel(self.searchInEntryName) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 2: FAILED to make a search in 'Add to channel' - 'My Media' tab that matches entry name")
                return 
            ...
            writeToLog("INFO","Step 5: Going to make a search in Add to channel - My Media that matches entry description")
            if self.common.channel.searchInAddToChannel(self.searchInEntryDescription) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 5: FAILED to make a search in Add to channel - My Media that matches entry description")
                return  
            ...
            writeToLog("INFO","Step 8: Going to make a search in Add to channel - My Media that matches single caption")
            if self.common.channel.searchInAddToChannel(self.searchInSingleCaption) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 8: FAILED to make a search in Add to channel - My Media that matches single caption")
                return   
            ...
            writeToLog("INFO","Step 13: Going to make a search in Add to channel - My Media that matches single tag")
            if self.common.channel.searchInAddToChannel(self.searchInSingleTag) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 13: FAILED to make a search in Add to channel - My Media that matches single tag")
                return   
            ...
            writeToLog("INFO","Step 18: Going to make a search in Add to channel - My Media that matches single quiz")
            if self.common.channel.searchInAddToChannel(self.searchInSingleQuiz) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 18: FAILED to make a search in Add to channel - My Media that matches single quiz")
                return   
            ...
            writeToLog("INFO","Step 23: Going to make a search in Add to channel - My Media that matches single slide")
            if self.common.channel.searchInAddToChannel(self.searchInSingleSlide) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 23: FAILED to make a search in Add to channel - My Media that matches single slide")
                return   
            ...
            writeToLog("INFO","Step 28: Going to make a search in Add to channel - My Media that matches single chapter")
            if self.common.channel.searchInAddToChannel(self.searchInSingleChapter) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 28: FAILED to make a search in Add to channel - My Media that matches single chapter")
                return   
            ...
            writeToLog("INFO","Step 33: Going to make a search in Add to channel - My Media that matches single comment")
            if self.common.channel.searchInAddToChannel(self.searchInSingleComment) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 33: FAILED to make a search in Add to channel - My Media that matches single comment")
                return   
            ...
            writeToLog("INFO","Step 38: Going to make a search in Add to channel - My Media that matches single poll")
            if self.common.channel.searchInAddToChannel(self.searchInSinglePoll) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 38: FAILED to make a search in Add to channel - My Media that matches single poll")
                return   
            ...
            writeToLog("INFO","Step 43: Going to make a search in Add to channel - My Media that matches single detail")
            if self.common.channel.searchInAddToChannel(self.searchInSingleDetail) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 43: FAILED to make a search in Add to channel - My Media that matches single detail")
                return   
