...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 4: Going to make a search in 'Add to gallery' - 'SR' tab that matches single caption")
            if self.common.channel.searchInAddToChannel(self.searchInSingleCaption, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 4: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single caption")
                return   
            ...
            writeToLog("INFO","Step 9: Going to make a search in 'Add to gallery' - 'SR' tab that matches single tag")
            if self.common.channel.searchInAddToChannel(self.searchInSingleTag, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 9: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single tag")
                return
            ...
            writeToLog("INFO","Step 14: Going to make a search in 'Add to gallery' - 'SR' tab that matches single quiz")
            if self.common.channel.searchInAddToChannel(self.searchInSingleQuiz, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 14: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single quiz")
                return 
            ...
            writeToLog("INFO","Step 19: Going to make a search in 'Add to gallery' - 'SR' tab that matches single slide")
            if self.common.channel.searchInAddToChannel(self.searchInSingleSlide, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 19: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single slide")
                return             
            ...
            writeToLog("INFO","Step 24: Going to make a search in 'Add to gallery' - 'SR' tab that matches single chapter")
            if self.common.channel.searchInAddToChannel(self.searchInSingleChapter, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 24: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single chapter")
                return
            ...
            writeToLog("INFO","Step 29: Going to make a search in 'Add to gallery' - 'SR' tab that matches single comment")
            if self.common.channel.searchInAddToChannel(self.searchInSingleComment, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 29: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single comment")
                return
            ...
            writeToLog("INFO","Step 34: Going to make a search in 'Add to gallery' - 'SR' tab that matches single poll")
            if self.common.channel.searchInAddToChannel(self.searchInSinglePoll, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 34: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single poll")
                return   
            ...
            writeToLog("INFO","Step 39: Going to make a search in 'Add to gallery' - 'SR' tab that matches single details")
            if self.common.channel.searchInAddToChannel(self.searchInSingleDetail, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 39: FAILED to make a search in 'Add to gallery' - 'SR' tab that matches single details")
                return  
