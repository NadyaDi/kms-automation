...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Approve/Reject - no search - Category Page - Pending tab
    # Test description:
    # Going to upload four Youtube entries, approve and reject them using normal and bulk options
    #================================================================================================================================
    testNum = "4697"
    ...
    filePath = "https://www.youtube.com/watch?v=usNsCeOV4GM"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName1 = "Approve and Reject - yt one"
            self.entryName2 = "Approve and Reject - yt two"
            self.entryName3 = "Approve and Reject - yt three"
            self.entryName4 = "Approve and Reject - yt four"
            ...
            for entry in self.entriesToUpload:
                ...
                writeToLog("INFO","Step " + str(i) + ": Going to upload " + entry +" entry")
                if self.common.upload.addYoutubeEntry(self.entriesToUpload[entry], entry) == False:
                    self.status = "Fail"
                    writeToLog("INFO","Step " + str(i) + ": FAILED to upload " + entry +"  entry")
                    return
                else:
                    i = i + 1
                i = i
