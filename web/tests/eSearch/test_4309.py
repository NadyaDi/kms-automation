...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.sortByMembersAndSubscribers = ("49965420-1-My Channels - Sort Channels C", "49965420-1-My Channels - Sort Channels B", "My Channels - Sort Channels A", "My Channels - Sort Channels D")
            ...
            self.sortByAlphabeticalZToA = ("My Channels - Sort Channels D", "4My Channels - Sort Channels C", "My Channels - Sort Channels B", "My Channels - Sort Channels A")
...
#                 return
            ...
            writeToLog("INFO","Step 26: Going to make a search in channels page")
            if self.common.channel.searchInMyChannelsAndChannelsWithoutVerifyResults(self.searchInMyChannels) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 26: FAILED to make a search in channels page")
                return    
