...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filters section - with search - Global Page
    # Test description:
    ...
    searchPage  = "Filters section - with search - Global Page"
    searchTerm  = "Filter"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchTerm) == False:
                self.status = "Fail"
