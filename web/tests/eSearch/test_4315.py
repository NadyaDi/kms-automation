...
class Test:
    ...
    # Test Name : eSearch - Sort by - Add to channel - My media and SR tabs
    # Test description:
    ...
    #    9. Media Count - The channels' order should be the channel with most media first
    #================================================================================================================================
    testNum = "4315"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.SortEntriesByComments               = ("C160E832-1-Sort by - Sort J", "C160E832-1-Sort by - Sort H", "C160E832-1-Sort by - Sort E", "C160E832-1-Sort by - Sort I", "C160E832-1-Sort by - Sort C", 
                                                        "C160E832-1-Sort by - Sort A", "C160E832-1-Sort by - Sort D", "C160E832-1-Sort by - Sort B", "C160E832-1-Sort by - Sort G", "C160E832-1-Sort by - Sort F")
            ...
            if self.common.channel.navigateToChannel("C160E832-1-Channel for sort by") == False:
                self.status = "Fail"
