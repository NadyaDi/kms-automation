...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - no search - co publisher and co editor - Channel Page
    # Test description:
    ...
    searchPage = "Channel Page - no search"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.listAnyOwner, enums.Ownership.ANY_OWNER.value, enums.Location.CHANNEL_PAGE, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, enums.Location.CHANNEL_PAGE, True], self.enumMediaEdit:[self.fourthtype, enums.Ownership.MEDIA_EDIT.value, enums.Location.CHANNEL_PAGE, False], self.enumMediaPublish:[self.fourthtype, enums.Ownership.MEDIA_PUBLISH.value, enums.Location.CHANNEL_PAGE, False]}
            ##################### TEST STEPS - MAIN FLOW #####################
            i = 1
            writeToLog("INFO","Step " + str(i) + ": Going to navigate to " + self.searchPage)
            if self.common.channel.navigateToChannel(self.channelName, navigateFrom=enums.Location.CHANNELS_PAGE, forceNavigate=True) == False:
                self.status = "Fail"
            ...
            for entry in self.entriesMap:
                ...
                if self.common.channel.verifyEntriesDisplay(self.entriesMap[entry][0], self.entriesMap[entry][2], self.entriesMap[entry][3]) == False:
                    self.status = "Fail"
