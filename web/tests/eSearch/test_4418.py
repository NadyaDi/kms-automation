...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 2: Going to make a search in 'Add to gallery - My Media' tab that matches entry name")
            if self.common.channel.searchInAddToChannel(self.searchInEntryName) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 2: FAILED to make a search in 'Add to gallery - My Media' tab that matches entry name")
                return 
            ...
            writeToLog("INFO","Step 5: Going to make a search in 'Add to gallery - My Media' tab that matches entry description")
            if self.common.channel.searchInAddToChannel(self.searchInEntryDescription) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 5: FAILED to make a search in 'Add to gallery - My Media' that matches entry description")
                return  
            ...
            writeToLog("INFO","Step 8: Going to make a search in 'Add to gallery - My Media' that matches single caption")
            if self.common.channel.searchInAddToChannel(self.searchInSingleCaption) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 8: FAILED to make a search in 'Add to gallery - My Media' that matches single caption")
                return   
            ...
            writeToLog("INFO","Step 13: Going to make a search in 'Add to gallery - My Media' that matches single tag")
            if self.common.channel.searchInAddToChannel(self.searchInSingleTag) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 13: FAILED to make a search in 'Add to gallery - My Media' that matches single tag")
                return   
            ...
            writeToLog("INFO","Step 18: Going to make a search in 'Add to gallery - My Media' that matches single quiz")
            if self.common.channel.searchInAddToChannel(self.searchInSingleQuiz) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 18: FAILED to make a search in 'Add to gallery - My Media' that matches single quiz")
                return   
            ...
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnField(True, enums.EntryFields.QUIZ) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 19: FAILED to verify single quiz field display after clicking on field name")
                return  
                  
            writeToLog("INFO","Step 20: Going to verify single quiz field display after clicking on show more button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowMore(True, enums.EntryFields.QUIZ, entryOwner=self.entryOwner, categoriesList=self.categoriesList) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 20: FAILED to verify single quiz field display after clicking on show more button")
                return  
                  
            writeToLog("INFO","Step 21: Going to verify single quiz field display after clicking on show all button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(True, enums.EntryFields.QUIZ) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 21: FAILED to verify single quiz field display after clicking on show all button")
                return 
            ...
            writeToLog("INFO","Step 23: Going to make a search in 'Add to gallery - My Media' that matches single slide")
            if self.common.channel.searchInAddToChannel(self.searchInSingleSlide) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 23: FAILED to make a search in 'Add to gallery - My Media' that matches single slide")
                return   
                  
            writeToLog("INFO","Step 24: Going to verify single slide field display after clicking on field name")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnField(True, enums.EntryFields.SLIDE) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 24: FAILED to verify single slide field display after clicking on field name")
                return  
                  
            writeToLog("INFO","Step 25: Going to verify single slide field display after clicking on show more button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowMore(True, enums.EntryFields.SLIDE, entryOwner=self.entryOwner, categoriesList=self.categoriesList) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 25: FAILED to verify single slide field display after clicking on show more button")
                return  
                  
            writeToLog("INFO","Step 26: Going to verify single slide field display after clicking on show all button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(True, enums.EntryFields.SLIDE) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 26: FAILED to verify single slide field display after clicking on show all button")
                return 
            ...
            writeToLog("INFO","Step 28: Going to make a search in 'Add to gallery - My Media' that matches single chapter")
            if self.common.channel.searchInAddToChannel(self.searchInSingleChapter) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 28: FAILED to make a search in 'Add to gallery - My Media' that matches single chapter")
                return   
                   
            writeToLog("INFO","Step 29: Going to verify single chapter field display after clicking on field name")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnField(True, enums.EntryFields.CHAPTER) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 29: FAILED to verify single chapter field display after clicking on field name")
                return  
                   
            writeToLog("INFO","Step 30: Going to verify single chapter field display after clicking on show more button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowMore(True, enums.EntryFields.CHAPTER, entryOwner=self.entryOwner, categoriesList=self.categoriesList) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 30: FAILED to verify single chapter field display after clicking on show more button")
                return  
                   
            writeToLog("INFO","Step 31: Going to verify single chapter field display after clicking on show all button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(True, enums.EntryFields.CHAPTER) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 31: FAILED to verify single chapter field display after clicking on show all button")
                return 
            ...
            writeToLog("INFO","Step 33: Going to make a search in 'Add to gallery - My Media' that matches single comment")
            if self.common.channel.searchInAddToChannel(self.searchInSingleComment) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 33: FAILED to make a search in 'Add to gallery - My Media' that matches single comment")
                return   
                   
            writeToLog("INFO","Step 34: Going to verify single comment field display after clicking on field name")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnField(True, enums.EntryFields.COMMENT) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 34: FAILED to verify single comment field display after clicking on field name")
                return  
                   
            writeToLog("INFO","Step 35: Going to verify single comment field display after clicking on show more button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowMore(True, enums.EntryFields.COMMENT, entryOwner=self.entryOwner, categoriesList=self.categoriesList) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 35: FAILED to verify single comment field display after clicking on show more button")
                return  
                   
            writeToLog("INFO","Step 36: Going to verify single comment field display after clicking on show all button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(True, enums.EntryFields.COMMENT) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 36: FAILED to verify single comment field display after clicking on show all button")
                return 
            ...
            writeToLog("INFO","Step 38: Going to make a search in 'Add to gallery - My Media' that matches single poll")
            if self.common.channel.searchInAddToChannel(self.searchInSinglePoll) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 38: FAILED to make a search in 'Add to gallery - My Media' that matches single poll")
                return   
                  
            writeToLog("INFO","Step 39: Going to verify single poll field display after clicking on field name")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnField(True, enums.EntryFields.POLL) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 39: FAILED to verify single poll field display after clicking on field name")
                return  
                  
            writeToLog("INFO","Step 40: Going to verify single poll field display after clicking on show more button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowMore(True, enums.EntryFields.POLL, entryOwner=self.entryOwner, categoriesList=self.categoriesList, isWebcast=True) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 40: FAILED to verify single poll field display after clicking on show more button")
                return  
                  
            writeToLog("INFO","Step 41: Going to verify single poll field display after clicking on show all button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(True, enums.EntryFields.POLL) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 41: FAILED to verify single poll field display after clicking on show all button")
                return 
            
            writeToLog("INFO","Step 42: Going to clear search")
            if self.common.channel.clearSearchInAddToChannel() == False:
                self.status = "Fail"
                writeToLog("INFO","Step 42: FAILED to clear search")
                return            
  
            writeToLog("INFO","Step 43: Going to make a search in 'Add to gallery - My Media' that matches single detail")
            if self.common.channel.searchInAddToChannel(self.searchInSingleDetail) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 43: FAILED to make a search in 'Add to gallery - My Media' that matches single detail")
                return   
                  
            writeToLog("INFO","Step 44: Going to verify detail comment field display after clicking on field name")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnField(True, enums.EntryFields.DETAILS) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 44: FAILED to verify detail comment field display after clicking on field name")
                return  
                  
            writeToLog("INFO","Step 45: Going to verify single detail field display after clicking on show more button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowMore(True, enums.EntryFields.DETAILS, entryOwner=self.entryOwner, categoriesList=self.categoriesList) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 45: FAILED to verify single detail field display after clicking on show more button")
                return  
                  
            writeToLog("INFO","Step 46: Going to verify single detail field display after clicking on show all button")
            if self.common.myMedia.verifyFieldDisplayInResultAfterClickingOnShowAll(True, enums.EntryFields.DETAILS) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 46: FAILED to verify single detail field display after clicking on show all button")
                return 
