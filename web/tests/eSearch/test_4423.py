...
class Test:
    ...
    # Test Name : eSearch - Fields display in results - Multiple - channel - media tab
    # Test description:
    # Upload entries with different cue points fields
    # Go to channel page - Media tab , make a search that matches multiple values in field, and check for field display in results
    #    1. Name
    #    2. Description
    #    3. Tag
    #    4. Details 
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 2: Going to make a search in channel - media tab that matches multiple captions")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleCaptions) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 2: FAILED to make a search in channel - media tab that matches multiple captions")
                return   
            ...
            writeToLog("INFO","Step 7: Going to make a search in channel - media tab that matches multiple tags")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleTags) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 7: FAILED to make a search in channel - media tab that matches multiple tags")
                return   
            ...
            writeToLog("INFO","Step 12: Going to make a search in channel - media tab that matches multiple quiz")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleQuiz) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 12: FAILED to make a search in channel - media tab that matches multiple quiz")
                return   
            ...
            writeToLog("INFO","Step 17: Going to make a search in channel - media tab that matches multiple slides")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleSlides) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 17: FAILED to make a search in channel - media tab that matches multiple slides")
                return   
            ...
            writeToLog("INFO","Step 22: Going to make a search in channel - media tab that matches multiple chapters")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleChapters) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 22: FAILED to make a search in My channel - media tab that matches multiple chapters")
                return   
            ...
            writeToLog("INFO","Step 27: Going to make a search in channel - media tab that matches multiple comments")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleComments) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 27: FAILED to make a search in channel - media tab that matches multiple comments")
                return   
            ...
            writeToLog("INFO","Step 32: Going to make a search in channel - media tab that matches multiple polls")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultiplePolls) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 32: FAILED to make a search in channel - media tab that matches multiple polls")
                return   
            ...
            writeToLog("INFO","Step 37: Going to make a search in channel - media tab that matches multiple details")
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchInMultipleDetails) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 37: FAILED to make a search in channel - media tab that matches multiple details")
                return   
