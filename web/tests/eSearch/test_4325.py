...
class Test:
    ...
    # Test Name : eSearch - Sort by - Gallery - media tab - when search is made
    # Test description:
    # Upload entries with different sort by values
    # Go to gallery page, media tab, make a search and make the next sorts (with and without search):
