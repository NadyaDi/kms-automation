...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Scheduling - Dependency with other filters - My Media 
    # Test description:
    # Verify that the Scheduling filter option is available for each entry media type
    #================================================================================================================================
    testNum = "4484"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            checkBoxLabelValue = "Future Scheduling undefined"
