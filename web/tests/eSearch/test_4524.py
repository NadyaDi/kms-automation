...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - no search - Add new quiz - negative and positive
    # Test description:
...
# SINGLE LIST NEGATIVE
            ...
            if self.common.kea.verifyFiltersInEditor(self.listInvalid) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.kea.verifyFiltersInEditor(self.singleListMap[entry][0]) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.kea.verifyFiltersInEditor(self.singleTextMap[entry]) == False:
                    self.status = "Fail"
...
#                 if self.common.kea.verifyFiltersInEditor(self.singleDateMap[entry]) == False:
#                     self.status = "Fail"
