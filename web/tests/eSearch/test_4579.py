...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - no search - co publisher - Channel Page
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.listAnyOwner, enums.Ownership.ANY_OWNER.value, enums.Location.CHANNEL_PAGE, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, enums.Location.CHANNEL_PAGE, True], self.enumMediaEdit:[self.listAllInvalid, enums.Ownership.MEDIA_EDIT.value, enums.Location.CHANNEL_PAGE, True], self.enumMediaPublish:[self.thirdtype, enums.Ownership.MEDIA_PUBLISH.value, enums.Location.CHANNEL_PAGE, False]}
