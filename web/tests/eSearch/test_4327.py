...
class Test:
    ...
    # Test Name : eSearch - Sort by - Channel - pending tab - when search is made
    # Test description:
    # Upload entries with different sort by values
    # Go to channel page, pending tab, make a search and make the next sorts (with and without search):
