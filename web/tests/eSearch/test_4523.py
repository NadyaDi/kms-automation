...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - with search - Add new quiz - negative and positive
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.listThree      = {self.entryName1: False, self.entryName2: False, self.entryName3: False, self.entryName4: False}
...
# SINGLE LIST NEGATIVE
            ...
            if self.common.kea.verifyFiltersInAddQuizPage(self.listInvalid) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.kea.verifyFiltersInAddQuizPage(self.singleListMap[entry][0]) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.kea.verifyFiltersInAddQuizPage(self.singleTextMap[entry]) == False:
                    self.status = "Fail"
...
#                 if self.common.kea.verifyFiltersInAddQuizPage(self.singleDateMap[entry]) == False:
#                     self.status = "Fail"
