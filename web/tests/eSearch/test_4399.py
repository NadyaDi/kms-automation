...
class Test:
    ...
    # Test Name : eSearch - Sort by - Add to channel - My media tab - when no search is made
    # Test description:
    # Upload entries with different sort by values
    # Go to Add to channel page, my media tab and make the next sorts:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.channel.verifySortInAddToChannel(enums.SortBy.UPDATE_ASC, self.sortEntriesByUpdateDateAscending) == False:
                ...
                return                                                      
            ##################################################################
            writeToLog("INFO","TEST PASSED: Sort by in 'Add to channel - My Media tab' - when no search is made was done successfully")
