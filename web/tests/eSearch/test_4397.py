...
class Test:
    ...
    # Test Name : eSearch - Fields display in results - Multiple - Global page
    # Test description:
    # Upload entries with different cue points fields
    # Go to Global page, make a search that matches multiple values in field, and check for field display in results
    #    1. Name
    #    2. Description
    #    3. Tag
    #    4. Details 
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 1: Going to make a search in global page that matches multiple captions")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleCaptions) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 1: FAILED to make a search in global page that matches multiple captions")
                return   
            ...
            writeToLog("INFO","Step 5: Going to make a search in global page that matches multiple tags")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleTags) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 5: FAILED to make a search in global page that matches multiple tags")
                return   
            ...
            writeToLog("INFO","Step 9: Going to make a search in global page that matches multiple quiz")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleQuiz) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 9: FAILED to make a search in global page that matches multiple quiz")
                return   
            ...
            writeToLog("INFO","Step 13: Going to make a search in global page that matches multiple slides")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleSlides) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 13: FAILED to make a search in global page that matches multiple slides")
                return   
            ...
            writeToLog("INFO","Step 17: Going to make a search in global page that matches multiple chapters")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleChapters) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 17: FAILED to make a search in global page that matches multiple chapters")
                return   
            ...
            writeToLog("INFO","Step 21: Going to make a search in global page that matches multiple comments")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleComments) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 21: FAILED to make a search in global page that matches multiple comments")
                return   
            ...
            writeToLog("INFO","Step 25: Going to make a search in global page that matches multiple polls")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultiplePolls) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 25: FAILED to make a search in global page that matches multiple polls")
                return   
            ...
            writeToLog("INFO","Step 29: Going to make a search in global page that matches multiple details")
            if self.common.globalSearch.makeAGloablSearchForEsearch(self.searchInMultipleDetails) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 29: FAILED to make a search in global page that matches multiple details")
                return   
