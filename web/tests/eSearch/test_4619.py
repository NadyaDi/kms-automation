...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumMediaPublish:[self.thirdtype, enums.Ownership.MEDIA_PUBLISH.value, enums.Location.ADD_TO_CHANNEL_MY_MEDIA, False], self.enumAnyOwner:[self.thirdtype, enums.Ownership.ANY_OWNER.value, enums.Location.ADD_TO_CHANNEL_MY_MEDIA, False]}
