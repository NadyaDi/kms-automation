...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 3: Going to make a search in 'Add to channel' - 'SR' tab that matches single caption")
            if self.common.channel.searchInAddToChannel(self.searchInSingleCaption, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 3: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single caption")
                return   
            ...
            writeToLog("INFO","Step 8: Going to make a search in 'Add to channel' - 'SR' tab that matches single tag")
            if self.common.channel.searchInAddToChannel(self.searchInSingleTag, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 8: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single tag")
                return
            ...
            writeToLog("INFO","Step 13: Going to make a search in 'Add to channel' - 'SR' tab that matches single quiz")
            if self.common.channel.searchInAddToChannel(self.searchInSingleQuiz, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 13: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single quiz")
                return 
            ...
            writeToLog("INFO","Step 18: Going to make a search in 'Add to channel' - 'SR' tab that matches single slide")
            if self.common.channel.searchInAddToChannel(self.searchInSingleSlide, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 18: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single slide")
                return             
            ...
            writeToLog("INFO","Step 23: Going to make a search in 'Add to channel' - 'SR' tab that matches single chapter")
            if self.common.channel.searchInAddToChannel(self.searchInSingleChapter, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 23: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single chapter")
                return
            ...
            writeToLog("INFO","Step 28: Going to make a search in 'Add to channel' - 'SR' tab that matches single comment")
            if self.common.channel.searchInAddToChannel(self.searchInSingleComment, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 28: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single comment")
                return
            ...
            writeToLog("INFO","Step 33: Going to make a search in 'Add to channel' - 'SR' tab that matches single poll")
            if self.common.channel.searchInAddToChannel(self.searchInSinglePoll, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 33: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single poll")
                return   
            ...
            writeToLog("INFO","Step 38: Going to make a search in 'Add to channel' - 'SR' tab that matches single details")
            if self.common.channel.searchInAddToChannel(self.searchInSingleDetail, tabToSearcFrom=enums.AddToChannelTabs.SHARED_REPOSITORY) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 38: FAILED to make a search in 'Add to channel' - 'SR' tab that matches single details")
                return  
