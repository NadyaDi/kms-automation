...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by custom-data - with search - Add to channel - SR tab - negative and positive
    # Test description:
    ...
    searchPage = "Add to channel - SR tab - with search"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step " + str(i) + ": Going to navigate to " + self.sRChannel)
            if self.common.channel.navigateToSrTabInAddToChannel(self.sRChannel) == False:
                self.status = "Fail"
                writeToLog("INFO","Step " + str(i) + ": FAILED to navigate to " + self.sRChannel)
                return
            else:
                i = i + 1
            i = i
...
# # SINGLE LIST NEGATIVE
            ...
            if self.common.channel.verifyFiltersInAddToChannel(self.listInvalid, enums.Location.ADD_TO_CHANNEL_SR) == False:
                self.status = "Fail"
...
# SINGLE LIST POSITIVE
            for entry in self.singleListMap:
                ...
                if self.common.channel.verifyFiltersInAddToChannel(self.singleListMap[entry][0], enums.Location.ADD_TO_CHANNEL_SR) == False:
                    self.status = "Fail"
...
# SINGLE TEXT POSITIVE
            for entry in self.singleTextMap:
                ...
                if self.common.channel.verifyFiltersInAddToChannel(self.singleTextMap[entry], enums.Location.ADD_TO_CHANNEL_SR) == False:
                    self.status = "Fail"
...
#                 if self.common.channel.verifyFiltersInAddToChannel(self.singleDateMap[entry], enums.Location.ADD_TO_CHANNEL_SR) == False:
#                     self.status = "Fail"
