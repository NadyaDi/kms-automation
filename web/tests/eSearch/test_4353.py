...
class Test:
    ...
    # Test Name : eSearch - Search In - Gallery - pending tab
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.channel.navigateToPendingaTab(self.gallery, location=enums.Location.CATEGORY_PAGE) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 1: FAILED to go to navigate gallery page")
                return      
            ...
            if self.common.channel.makeSearchInPending(self.searchInGallery) == False:
                self.status = "Fail"
