...
class Test:
    ...
    # Test Name : eSearch - Search In - My Media
    # Test description:
    # Upload entries with different cue points fields
    # Go to My Media, make a search, and filter entries by 'Search in' drop down:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 3: Going to make a search in My Media")
            if self.common.myMedia.searchEntryMyMedia(self.searchInMyMedia) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 3: FAILED to make a search in My Media")
                return 
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.searchInQuiz) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.searchInAllFields) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.searchInDeatails) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.searchInChaptersAndSlides) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.SearchIncaptions) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.searchInPolls) == False:
                self.status = "Fail"
            ...
            if self.common.myMedia.verifyFiltersInMyMedia(self.searchInComments) == False:
                self.status = "Fail"
