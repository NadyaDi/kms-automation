...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Approve/Reject - with search - Channel Page - Pending tab
    # Test description:
    # Going to upload four Image entries, approve and reject them using normal and bulk options
    #================================================================================================================================
    testNum = "4682"
    ...
    filePath = localSettings.LOCAL_SETTINGS_MEDIA_PATH + r'\images\automation2.jpg'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName1 = "Approve and Reject - img one"
            self.entryName2 = "Approve and Reject - img two"
            self.entryName3 = "Approve and Reject - img three"
            self.entryName4 = "Approve and Reject - img four"
            ...
            writeToLog("INFO","Step " + str(i) + ": Going  to search by " + self.searchTerm + " in " + self.channelNamePending)
            if self.common.channel.makeSearchInPending(self.searchTerm) == False:
                self.status = "Fail"
                writeToLog("INFO","Step " + str(i) + ": FAILED to search by " + self.searchTerm + " in " + self.channelNamePending)
                return
            else:
                i = i + 1
            i = i
            ...
            writeToLog("INFO","Step " + str(i) + ": Going  to search by " + self.searchTerm + " in " + self.channelNamePending)
            if self.common.channel.searchInChannelWithoutVerifyResults(self.searchTerm) == False:
                self.status = "Fail"
                writeToLog("INFO","Step " + str(i) + ": FAILED to search by " + self.searchTerm + " in " + self.channelNamePending)
                return
            else:
