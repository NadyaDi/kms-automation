...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - with search - co publisher and co editor - My Media
    # Test description:
    ...
    searchPage = "My Media - with search"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            for entry in self.entriesMap:
                ...
                if self.common.myMedia.verifyFiltersInMyMedia(self.entriesMap[entry][0], self.entriesMap[entry][2]) == False:
                    self.status = "Fail"
