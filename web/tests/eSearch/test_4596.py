...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.listAnyOwner, enums.Ownership.ANY_OWNER.value, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, True], self.enumMediaEdit:[self.listBoth, enums.Ownership.MEDIA_EDIT.value, False], self.enumMediaPublish:[self.listBoth, enums.Ownership.MEDIA_PUBLISH.value, False]}
