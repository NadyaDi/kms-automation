...
class Test:
    ...
    # Test Name : eSearch - Sort by - Channel - media tab - when search is made
    # Test description:
    # Upload entries with different sort by values
    # Go to channel page, media tab, make a search and make the next sorts:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.channel.navigateToChannel(self.channel) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 3: FAILED to go to navigate channel page")
                return            
