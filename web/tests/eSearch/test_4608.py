...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - with search - co publisher and co editor - Add to channel - My Media tab
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entriesMap = {self.enumAnyOwner:[self.fourthtype, enums.Ownership.ANY_OWNER.value, enums.Location.ADD_TO_CHANNEL_MY_MEDIA, False], self.enumMediaOwn:[self.listAllInvalid, enums.Ownership.MEDIA_OWN.value, enums.Location.ADD_TO_CHANNEL_MY_MEDIA, True], self.enumMediaPublish:[self.fourthtype, enums.Ownership.MEDIA_PUBLISH.value, enums.Location.ADD_TO_CHANNEL_MY_MEDIA, False]}
            ##################### TEST STEPS - MAIN FLOW #####################
            i = 1
            writeToLog("INFO","Step " + str(i) + ": Going to navigate to " + self.channelName)
            if self.common.channel.navigateToAddToChannel(self.channelName, navigateFrom=enums.Location.CHANNELS_PAGE, forceNavigate=True) == False:
                self.status = "Fail"
