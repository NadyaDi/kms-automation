...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Channel Membership - with search - My Channels page
    # Test description:
    ...
    searchPage       = "My Channels Page - with search"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            i = 1
            writeToLog("INFO","Step " + str(i) + ": Going to navigate to " + self.navigatePage + " and search for " + self.searchTerm)
            if self.common.channel.searchAChannelInMyChannels(self.searchTerm, needToBeFound=True, exactName=True) == False:
                self.status = "Fail"
                writeToLog("INFO","Step " + str(i) + ": FAILED to navigate to " + self.navigatePage + " and search for " + self.searchTerm)
                return
            else:
                i = i + 1
            i = i
