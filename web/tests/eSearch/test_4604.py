...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Filter by Ownership - no search - co publisher and co editor - Add new quiz - with search
    # Test description:
    ...
    searchPage = "Add new quiz - no search"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            for entry in self.entriesMap:
                ...
                if self.common.kea.verifyFiltersInEditor(self.entriesMap[entry][0], self.entriesMap[entry][2]) == False:
                    self.status = "Fail"
