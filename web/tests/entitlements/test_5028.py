...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Entitlements - Public Restricted Channel using Global Page and Anonymous Users ON
    # Test description:
    # 1. Create a Public Restricted Channel
    # 2. Publish an entry inside the Public Restricted Channel
    ...
    # 5. Verify that the Anonymous user, KMS User, Channel Member and Contributor are able to access the channel, entry by tag and entry from global page
    #================================================================================================================================
    testNum = "5028"
    ...
    entryTags           = "publicchannelauto,"
    
    channelName         = None
    channelDescription  = "Public Channel Description"
    channelTags         = "publicchannelauto,"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 10: Going to verify that the tag: " + self.entryTags + " , linked to the " + self.entryName + " entry, and " + self.channelName + " channel and that it's displayed in global search results")
            if self.common.globalSearch.serchAndVerifyTagsInGlobalSearch(self.entryTags, self.entryName, self.channelName) == False:
                writeToLog("INFO","Step 10: FAILED, the "+ self.channelName + " channel, and " + self.entryName + " entry couldn't be found in  Global Search results, while using " + self.entryTags + " tag")
                return 
            ...
            if self.common.globalSearch.serchAndVerifyChannelInGlobalSearch(self.channelName) == False:
                writeToLog("INFO","Step 20: FAILED, the "+ self.channelName + " channel hasn't been found in in the global search results while it should")
                return
