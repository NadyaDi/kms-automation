...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Entitlements - Public Restricted Channel using Global Page and Anonymous Users OFF
    # Test description:
    # 1. Create a Public Restricted Channel
    # 2. Publish an entry inside the Public Restricted Channel
    # 3. Add a member and a contributor to the Public Restricted channel
