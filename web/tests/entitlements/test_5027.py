...
class Test:
    ...
    # 5. Verify that the Anonymous user and KMS User are unable to find the channel, entry by tag and entry in global page
    # 6. Verify that the Channel Member and Contributer are able to find the channel, entry by tag and entry in global page
    #================================================================================================================================
    testNum = "5027"
    ...
    entryTags           = "sharedchannelauto,"
    
    channelName         = None
    channelDescription  = "Shared Repository Channel Description"
    channelTags         = "sharedchannelauto,"
