        ...
        try:
            ...
            if self.common.entryPage.navigateToEntryPageFromMyMedia(self.entryName) == False:
                ...
                if self.common.myMedia.searchEntryMyMedia(self.entryName, forceNavigate=False) == False:
                    writeToLog("INFO","Step 7.1: FAILED to navigate to the entry page for " + self.entryName + " entry as " + self.coPublisherUser)
                    return 
                sleep(2)
                if self.common.myMedia.clickEntryAfterSearchInMyMedia(self.entryName) == False:
                    writeToLog("INFO","Step 7.2: FAILED to navigate to the entry page for " + self.entryName + " entry as " + self.coPublisherUser)
                    return                
                sleep(5)
