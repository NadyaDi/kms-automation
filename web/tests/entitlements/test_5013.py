...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Entitlements - Public Restricted Channel using Channels Page and Anonymous Users OFF
    # Test description:
    ...
    # 4. Verify that the Channel owner has full control over the Public Restricted channel
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.channelName           = clsTestService.addGuidToString("Public Restricted Channel Anonymous OFF", self.testNum)
