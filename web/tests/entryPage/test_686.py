...
class Test:
    ...
    # test Name: Entry page - Like Unlike
    # Test description: Like entry, and then unlike entry
    # The test's Flow: 
    # Login to KMS-> Upload entry -> Go to entry page > Click on like button -> Click again on like button to unlike
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ########################################################################
            self.entryName = clsTestService.addGuidToString('likeUnlikeEntry', self.testNum)
