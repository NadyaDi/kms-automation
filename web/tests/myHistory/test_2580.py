...
class Test:
    ...
    # The test's Flow: 
    # Login to KMS-> Upload entry -> publish entry to restricted channel -> Go to My history and check that entry isn't displayed -> Go to entry page and play entry -> Go to
    ...
    # Test variables
    entryName= None
    channelList = ['RestrictedChannelMyHistory']
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 2: Going to publish entry to restricted channel")
