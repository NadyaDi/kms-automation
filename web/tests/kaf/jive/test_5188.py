...
class Test:
    ...
    # Test Name : Jive - Embed media in document - v2
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName = clsTestService.addGuidToString("EmbedDocumentFromMyMediaV2", self.testNum)
            self.documentName = clsTestService.addGuidToString("Embed document from My Media v2", self.testNum)
            ...
            if self.common.jive.createEmbedMedia(self.documentName, self.entryName, isDiscussion=False, isDocument=True, v3=False) == False:
