...
class Test:
    ...
    # Test Name : Jive - My Media - Filter Media View Different Statuses
    # Test description:
    # upload 4 entries
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.jive.logOutOfJive()== False:
            ...
            if  self.common.jive.loginToJive(self.userName1, self.userPass1)  == False:
            ...
            if self.common.jive.loginToJive(localSettings.LOCAL_SETTINGS_LOGIN_USERNAME, localSettings.LOCAL_SETTINGS_LOGIN_PASSWORD) == False:
            ...
            ##################################################################
            self.status = "Pass"
            writeToLog("INFO","TEST PASSED: 'Jive - My Media - Filter Media View Different Statuses' was done successfully")
    ...
    def teardown_method(self,method):
        try:
            ...
            self.common.base.switch_to_default_content()
            if (localSettings.LOCAL_SETTINGS_LOGIN_USERNAME in self.common.jive.getJiveLoginUserName()) == False:
                self.common.jive.logOutOfJive()
                self.common.jive.loginToJive(localSettings.LOCAL_SETTINGS_LOGIN_USERNAME, localSettings.LOCAL_SETTINGS_LOGIN_PASSWORD)
