...
class Test:
    ...
    # Test Name : Jive - My Media - Search by Name / Description / Tags 
    # Test description:
    # Upload entry
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.status = "Pass"
            writeToLog("INFO","TEST PASSED: 'Jive: My Media - Search by Name / Description / Tags' was done successfully")
