...
class Test:
    #================================================================================================================================
    # @Author: Oded Berihon
    # Test Name: Share_point - Entry page - Add captions And Search - remove caption
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.editEntryPage.removeCaption(self.captionLabel) == False:
                ...
                return
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Share_point - Add captions And Search' was done successfully")
