...
class Test:
    ...
    # Test Name:  SharePoint - Gallery Moderation
    # Test description::
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.sharePoint.loginToSharepoint(self.newUserId, self.newUserPass) == False:
                self.status = "Fail"
            ...
            try:
                ...
                return
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Share point - Gallery Moderated' was done successfully")
