...
class Test:
    ...
    # Test Name : D2L - My Media - Filter Media View Different Statuses
    # Test description:
    # upload 4 entries
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if  self.common.d2l.loginToD2L(self.userName1, self.userPass1)  == False:
                self.status = "Fail"
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'D2L: My Media - Filter Media View Different Statuses' was done successfully")
