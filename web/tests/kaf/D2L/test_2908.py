...
#             if self.common.d2l.createEmbedDiscussion(self.discussionName, 'E60400AE-2908-EmbedFromMyMedia') == False:
#                 self.status = "Fail"
#                 writeToLog("INFO","Step 5: FAILED to create embed discussion")
#                 return             
#             
#             writeToLog("INFO","Step 6: Going to to verify embed announcement")    
#             if self.common.kafGeneric.verifyEmbedEntry('E60400AE-2908-EmbedFromMyMedia', '', self.timeToStop, enums.Application.D2L) == False:
#                 self.status = "Fail"
#                 writeToLog("INFO","Step 6: FAILED to verify embed announcement")
#                 return     
#             
            writeToLog("INFO","Step 6: Going to to delete embed announcement")    
            if self.common.d2l.deleteDiscussion('25B8421A-2908-Embed video from My Media') == False:
                self.status = "Fail"
