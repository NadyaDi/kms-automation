...
class Test:
    ...
    # Test Name : D2L - Publish after upload
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.kafGeneric.navigateToGallery(self.galleryName) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 4: FAILED navigate to gallery: " + self.galleryName)
                return
            ...
            if self.common.channel.searchEntryInChannel(self.entryName) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 5: FAILED to find entry ' " + self.entryName + "' in gallery: " + self.galleryName)
                return 
           
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'D2L - Publish after upload' was done successfully")
