...
class Test:
    ...
    # Test Name : Sakai - Preview all kinds of media from My Media and Gallery
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.sakai.navigateToMyMediaSakai() == False:
                self.status = "Fail"
            ...
            if self.common.sakai.navigateToGallerySakai(self.galleryName) == False:
                self.status = "Fail"
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Sakai - Preview all kinds of media from My Media and Gallery' was done successfully")
