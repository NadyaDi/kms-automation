...
class Test:
    ...
    # Test Name : Sakai - My Media - Filter Media View Different Statuses
    # Test description:
    # upload 4 entries
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if  self.common.sakai.loginToSakai(self.userName1, self.userPass1)  == False:
                self.status = "Fail"
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Sakai - My Media - Filter Media View Different Statuses' was done successfully")
