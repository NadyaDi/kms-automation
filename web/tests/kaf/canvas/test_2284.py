...
class Test:
    ...
    # Test Name : Canvas - Preview all kinds of media from My Media and Gallery
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Canvas - Preview all kinds of media from My Media and Gallery' was done successfully")
