...
class Test:
    ...
    # Test Name : Canvas - My Media - Search by Name / Description / Tags 
    # Test description:
    # Upload entry
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.base.is_visible(self.common.myMedia.MY_MEDIA_NO_ENTRIES_FOUND) == False:
                ...
                return              
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Canvas: My Media - Search by Name / Description / Tags' was done successfully")
