...
class Test:
    ...
    # Test Name : Moodle - Publish from my media (single and multiple)
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.moodle.navigateToGalleryMoodle(self.galleryName) == False:
                self.status = "Fail"
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Moodle - Publish from my media (single and multiple)' was done successfully")
