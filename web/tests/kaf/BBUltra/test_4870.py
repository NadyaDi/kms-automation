...
class Test:
    #================================================================================================================================
    # @Author: Oded Berihon
    # Test Name : Blackboard_ULTRA - Preview all kinds of media from My Media and Gallery
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.blackBoardUltra.navigateToMyMediaBlackboardUltra() == False:
                self.status = "Fail"
            ...
            writeToLog("INFO","Step 12: Going navigate to Media Gallery")  
            if self.common.blackBoardUltra.navigateToGalleryBlackBoardUltra(self.galleryName, forceNavigate=True) == False:
                self.status = "Fail"
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'Blackboard_ULTRA - Preview all kinds of media from My Media and Gallery' was done successfully")
