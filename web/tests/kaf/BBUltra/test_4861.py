...
class Test:
    #================================================================================================================================
    # @Author: Oded Berihon
    # Test Name: BLACKBOARD_ULTRA - Edit Entry page - Close discussion
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            writeToLog("INFO","TEST PASSED: 'BLACKBOARD_ULTRA - Edit Entry page - Close discussion' was done successfully")
