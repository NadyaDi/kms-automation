...
class Test:
    #================================================================================================================================
    # @Author: Oded Berihon
    # Test Name : BlackBoard_ultra: My Media - Filter Media View Different Statuses
    # Test description:
    # upload 4 entries
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.blackBoardUltra.loginToBlackBoardUltra(self.userName1, self.userPass1) == False:
            ...
            if self.common.blackBoardUltra.loginToBlackBoardUltra(localSettings.LOCAL_SETTINGS_LOGIN_USERNAME, localSettings.LOCAL_SETTINGS_LOGIN_PASSWORD) == False:
            ...
            ##################################################################
            self.status = "Pass"
            writeToLog("INFO","TEST PASSED: 'BlackBoard ultra: My Media - Filter Media View Different Statuses' was done successfully")
