...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            sleep(1)
            writeToLog("INFO","Step 10: Going to filter and verify my media entries by: " + enums.MediaType.AUDIO.value)  
            ...
            sleep(1)
            writeToLog("INFO","Step 11: Going to filter and verify my media entries by: " + enums.MediaType.VIDEO.value)  
            ...
            sleep(1)
            writeToLog("INFO","Step 12: Going to filter and verify my media entries by: " + enums.MediaType.IMAGE.value)  
            if self.common.myMedia.verifyFiltersInMyMedia(enums.MediaType.ALL_MEDIA, self.filterByAllMedia) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 12: FAILED to filter and verify my media entries  by '" + enums.MediaType.ALL_MEDIA.value + "'")
                return 
            ##################################################################
