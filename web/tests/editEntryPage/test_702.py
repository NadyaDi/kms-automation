...
class Test:
    ...
    filePathImageDownload = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + '/TestingAutomation.png'
    filePathImageOriginalJenkinsNode = localSettings.LOCAL_SETTINGS_JENKINS_NODE_MEDIA_PATH + '/images/TestingAutomation.png'
    
    filePathAudio = localSettings.LOCAL_SETTINGS_MEDIA_PATH + r'\audios\audio.mp3'
    filePathAudioDownload = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + '/audio.mp3'
    filePathAudioOriginalJenkinsNode = localSettings.LOCAL_SETTINGS_JENKINS_NODE_MEDIA_PATH + '/audios/audio.mp3'
    
    filePathVideo = localSettings.LOCAL_SETTINGS_MEDIA_PATH + r'\videos\QR_Code_10sec.mp4'
    filePathVideoDownload = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + '/QR_Code_10sec.mp4'
    filePathVideoOriginalJenkinsNode = localSettings.LOCAL_SETTINGS_JENKINS_NODE_MEDIA_PATH + '/videos/QR_Code_10sec.mp4'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.tmpFolderPath = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + '/' + localSettings.LOCAL_SETTINGS_GUID
            localSettings.LOCAL_SETTINGS_TEMP_DOWNLOADS = self.tmpFolderPath
            ...
            if self.common.createFolder(self.tmpFolderPath) == False:
                self.status = "Fail"
            ...
            for path in self.filePathDictionary:  
                ...
                if self.common.editEntryPage.downloadAttachmentFileFromEditPage(self.filePathMedia, self.tmpFolderPath + '/' + fileName) == False:
                    self.status = "Fail"
    ...
    def teardown_method(self,method):
        try:
            ...
            self.common.deleteFolder(self.tmpFolderPath)
