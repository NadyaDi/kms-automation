...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Entry Design - Custom CSS
    # Test description:
    # Create a new video entry, in order to change its Entry Design
    # Change the CSS properties of the body while being in the Entry Page, Display Tab
    # Verify that the new CSS properties are displayed in the Entry Page
    #================================================================================================================================
    testNum = "5473"
    ...
    typeTest            = "Entry that has in the Entry Page custom CSS properties"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName             = clsTestService.addGuidToString("Entry Design - Custom CSS", self.testNum)
            ...
            writeToLog("INFO","Step 5: Going to change the Entry Design by using Custom CSS properties")
            if self.common.editEntryPage.changeEntryDisplay('', '', self.cssFilePath, '') == False:
                writeToLog("INFO","Step 5: FAILED to change the Entry Design by using Custom CSS properties")
                return
