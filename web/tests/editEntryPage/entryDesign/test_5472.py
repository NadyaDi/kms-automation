...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Entry Design - Background Color
    # Test description:
    # Create a new video entry, in order to change its Entry Design
    # Change the background color of the body while being in the Entry Page, Display Tab
    # Verify that the new background color is displayed in the Entry Page
    #================================================================================================================================
    testNum = "5472"
    ...
    typeTest            = "Entry that has in the Entry Page a new background color"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName             = clsTestService.addGuidToString("Entry Design - Background Color", self.testNum)
            ...
            writeToLog("INFO","Step 5: Going to change the Entry Design by modifying the Background Color")
            if self.common.editEntryPage.changeEntryDisplay('', '#C06C84', '', '') == False:
                writeToLog("INFO","Step 5: FAILED to change the Entry Design by modifying the Background Color")
                return
            ...
            if self.common.entryPage.verifyEntryDisplay('', '#C06C84', '', '') == False:
