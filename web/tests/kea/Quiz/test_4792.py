...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Quiz - KEA Quiz Question types - Submitted Quiz 50% score with Media Owner 
    # Test description:
    ...
    typeTest      = 'Quiz Entry Submitted State with 50% score and Media Owner user'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.entryName       = clsTestService.addGuidToString("Quiz - Question Types Submitted 50 score", self.testNum)
            self.newEntryName    = clsTestService.addGuidToString("Quiz - Question Types Submitted 50 score - Quiz", self.testNum)
            ...
            if self.common.player.quizVerification(self.questionDict, self.expectedQuizStateNew, submittedQuiz=True, resumeQuiz=False, newQuiz=False, expectedQuizScore=str(50), location=enums.Location.ENTRY_PAGE, timeOut=60) == False:
                self.status = "Fail"
