...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name :  Quiz - Resumed Quiz for Audio Entry
    # Test description:
    # Verify that the user is able to resume a quiz audio entry after answering to the 'Multiple Choice' and watching the 'Reflection Point' question types
    ...
    typeTest = 'Quiz Audio Entry Resumed State with Media Owner user'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.entryName       = clsTestService.addGuidToString("Quiz - Audio Entry Resumed", self.testNum)
            self.newEntryName    = clsTestService.addGuidToString("Quiz - Audio Entry Resumed - Quiz", self.testNum)
