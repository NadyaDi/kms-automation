...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Quiz Details - Download functionality
    # Test description:
    # Verify that the Allow Download of Questions List option has proper functionality by downloading the PDF file
    #================================================================================================================================
    testNum = "4757"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.player.downloadQuizPDF(self.filePathDownloaded) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 3: FAILED to download the PDF file")
                return
                 
            ##################################################################
            writeToLog("INFO","TEST PASSED: The download option for the Allow Download of Questions List option has proper functionality")
