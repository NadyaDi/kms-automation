...
class Test:
    ...
    firstQuestionAnswers = [questionNumber1Attempt1, '', 'QA Automation', 1, 0]
    secondQuestionAnswers = [questionNumber2Attempt1, '', 'QA Automation', 0, 1]
    thirdQuestionAnswers = [questionNumber3Attempt1, answerquestionNumber3Attempt1, 'QA Automation', 1, 0]
    # List with all answers
    answersDict = {'1':firstQuestionAnswers,'2':secondQuestionAnswers, '3': thirdQuestionAnswers}
...
#                 return    
            ...
            if self.common.player.verifyQuizAnswersInAnalytics(self.answersDict) == False:
                self.status = "Fail"
