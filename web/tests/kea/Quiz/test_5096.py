...
class Test:
    ...
    # Test Name : Quiz - Retake quiz Latest score
    # Test description:
    # Go to editor page and create quiz with option to retake quiz - 3 attempts
    # Go to quiz page and verify that user is able to retake quiz 3 times3 attempts
    #================================================================================================================================
    testNum = "5096"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.status = "Pass"
            writeToLog("INFO","TEST PASSED: Retake quiz - based on latest score was created and answered successfully")
