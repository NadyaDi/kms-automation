...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Quiz - KEA Quiz Question types - Submitted Quiz 0% score with Media Owner 
    # Test description:
    # Verify that the user is able to resume a submitted quiz entry after answering wrong to the 'Multiple Choice', 'True and False' and watching the 'Reflection Point' question types
    ...
    typeTest      = 'Quiz Entry Submitted State with 0% score and Media Owner user'
    ...
    questionAnswerOne        = ['Question Title for Multiple Choice', 'question #1 option #2', False]
    questionAnswerTwo        = ['Question Title for True and False', 'False text', False]
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.entryName       = clsTestService.addGuidToString("Quiz - Question Types Submitted 0 score", self.testNum)
            self.newEntryName    = clsTestService.addGuidToString("Quiz - Question Types Submitted 0 score - Quiz", self.testNum)
            ...
            if self.common.player.quizVerification(self.questionDict, self.expectedQuizStateNew, submittedQuiz=True, resumeQuiz=False, newQuiz=False, expectedQuizScore=str(0), location=enums.Location.ENTRY_PAGE, timeOut=60) == False:
                self.status = "Fail"
