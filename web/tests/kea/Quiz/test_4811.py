...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name : Quiz - Submitted Quiz for Youtube Entry
    # Test description:
    # Verify that the user is able to resume a submitted quiz youtube entry after answering to the 'Multiple Choice', 'True and False' and watching the 'Reflection Point' question types
    ...
    typeTest        = 'Quiz Youtube Entry Submitted State with 100% score and Media Owner user'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.entryName       = clsTestService.addGuidToString("Quiz - Youtube Entry Submitted 100 score", self.testNum)
            self.newEntryName    = clsTestService.addGuidToString("Quiz - Youtube Entry Submitted 100 score - Quiz", self.testNum)
