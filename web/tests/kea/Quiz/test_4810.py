...
class Test:
    ...
    #================================================================================================================================
    #  @Author: Horia Cus
    # Test Name :  Quiz - New Quiz for Audio Entry
    # Test description:
    # Verify that the user is able to start a new quiz audio entry, with 'Multiple Choice', 'True and False' and 'Reflection Point' quiz question types unanswered 
    ...
    typeTest = 'Quiz Audio Entry New State with Media Owner user'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            ##################################################################
            self.entryName       = clsTestService.addGuidToString("Quiz - Audio Entry New", self.testNum)
            self.newEntryName    = clsTestService.addGuidToString("Quiz - Audio Entry New - Quiz", self.testNum)
