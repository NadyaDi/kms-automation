...
class Test:
    ...
    questionNumber1Changed = ['00:13', enums.QuizQuestionType.Multiple, 'question #1 Title'] 
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            if self.common.kea.changeTimelineOrder(self.changeTimelineOrderDict) == False:
                self.status = "Fail"
