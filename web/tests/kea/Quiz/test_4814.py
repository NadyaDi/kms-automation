...
class Test:
    ...
    questionMultipleSeven       = ['00:45', enums.QuizQuestionType.Multiple, 'Question Title for Multiple Choice Seven', 'question #1 option #1', 'question #1 option #2', 'question #1 option #3', 'question #1 option #4', 'Hint Text for Multiple Choice', 'Why Text For Multiple Choice']
    questionTrueAndFalseEight   = ['00:50', enums.QuizQuestionType.TRUE_FALSE, 'Question Title for True and False Eight', 'True text', 'False text', 'Hint Text for True and False', 'Why Text For True and False']
    questionReflectionNine      = ['01:00', enums.QuizQuestionType.REFLECTION, 'Question Title for Reflection Point Nine']
    questionMultipleTen         = ['01:10', enums.QuizQuestionType.Multiple, 'Question Title for Multiple Choice Ten', 'question #1 option #1', 'question #1 option #2', 'question #1 option #3', 'question #1 option #4', 'Hint Text for Multiple Choice', 'Why Text For Multiple Choice']
    questionTrueAndFalseEleven  = ['01:20', enums.QuizQuestionType.TRUE_FALSE, 'Question Title for True and False Eleven', 'True text', 'False text', 'Hint Text for True and False', 'Why Text For True and False']
    questionReflectionTwelve    = ['01:30', enums.QuizQuestionType.REFLECTION, 'Question Title for Reflection Point Twelve']
    questionMultipleThirteen    = ['01:40', enums.QuizQuestionType.Multiple, 'Question Title for Multiple Choice Thirteen', 'question #1 option #1', 'question #1 option #2', 'question #1 option #3', 'question #1 option #4', 'Hint Text for Multiple Choice', 'Why Text For Multiple Choice']
    questionTrueAndFalseFourteen= ['01:50', enums.QuizQuestionType.TRUE_FALSE, 'Question Title for True and False Fourteen', 'True text', 'False text', 'Hint Text for True and False', 'Why Text For True and False']
    questionReflectionFifteen   = ['02:00', enums.QuizQuestionType.REFLECTION, 'Question Title for Reflection Point Fifteen']
