...
class Test:
    ...
    # Test Name : Quiz - Analytics - Clear all attempts when no attempts still left
    # Test description:
    ...
    # Verify that user row was deleted and other users row are still displayed -> Verify that user is able to answer quiz from begining and that he has 3 attempts
    #================================================================================================================================
    testNum = "5135"
    ...
    questionNumber2 = "question #2 Title"
    questionNumber3 = "question #3 Title"
    ...
    quizAnswersDictAttempt1User1 = {questionNumber1:answerquestionNumber1Attempt1User1, questionNumber2:answerquestionNumber2Attempt1User1, questionNumber3:answerquestionNumber3Attempt1User1}
    quizAnswersDictAttempt2User1 = {questionNumber1:answerquestionNumber1Attempt2User1, questionNumber2:answerquestionNumber2Attempt2User1, questionNumber3:answerquestionNumber3Attempt2User1}
    quizAnswersDictAllAttemptsUser1 = [quizAnswersDictAttempt1User1, quizAnswersDictAttempt2User1]
    
    # User 2 answers for 1 attempt
    quizAnswersDictAttempt1User2 = {questionNumber1:answerquestionNumber1Attempt1User2, questionNumber2:answerquestionNumber2Attempt1User2, questionNumber3:answerquestionNumber3Attempt1User2}
    ...
    quizAnswersDictAttempt3User3 = {questionNumber1:answerquestionNumber1Attempt3User3, questionNumber2:answerquestionNumber3Attempt2User3, questionNumber3:answerquestionNumber3Attempt3User3}
    ...
    usersDataInAnalyticsAfterDeletion = {'1':user1DataInAnalytics, '2':user2DataInAnalytics}
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            i = i + 1           
            writeToLog("INFO","Step " + str(i) + ": Going to login as " + self.userName1)  
            ...
            if self.common.quizAnalytics.verifyUserAttemptsAndScore(self.userId1, self.userNameUser2, self.numberOfAttemptsUser1, self.scoreUser1, enums.playerQuizScoreType.LATEST) == True:
                self.status = "Fail"
...
#             i = i + 1    
#             writeToLog("INFO","Step " + str(i) + ": Going to answer quiz " + self.quizEntryName)  
#             if self.common.player.verifyQuizAttempts(self.quizQuestionsDictAttemptsAfterClearingAllAttempts, expectedQuizScore=self.quizSpecificAttemptScoreAfterClearingAllAttempts, totalGivenAttempts=self.totalGivenAttempts, expectedAttemptGeneralScore=self.quizGeneralAttemptsScoreAfterClearingAllAttempts, scoreType=enums.playerQuizScoreType.LATEST) == False:     
#                 self.status = "Fail"
#                 writeToLog("INFO","Step " + str(i) + ": FAILED: to answer quiz " + self.quizEntryName)
#                 return     
#               
