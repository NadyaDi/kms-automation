...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.filePathExoprtedQuizAnswersAfterClearingAttempts = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + "/quiz_users.csv"
            ...
            self.filePathExoprtedQuizAnswersAfterRetakingQuiz = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + "/quiz_users(1).csv"
