...
class Test:
    ...
    filePathExoprtedQuizAnswersAfterClearingAttempts = localSettings.LOCAL_SETTINGS_JENKINS_NODE_MEDIA_PATH + '/quiz_answers.csv'
...
#    filePathExoprtedQuizAnswersAfterClearingAttempts = 'C:\\Users\\inbar.willman\\eclipse-workspace\\kms-automation\\web\\temp\\downloads\\quiz_answers.csv'
    ...
    filePathExoprtedQuizAnswersAfterRetakingQuiz = localSettings.LOCAL_SETTINGS_JENKINS_NODE_MEDIA_PATH + '/quiz_answers(1).csv'
