...
class Test:
    ...
    # Test Name : Quiz - Analytics - Export quiz answerss - after clearing all attempts
    # Test description:
    ...
    # Go to analytics page -> quiz users tab -> Clear all user attempts -> Export csv -> Take the quiz again -> Login as admin and navigate to analytics page -> quiz users tab -> Export csv
    #================================================================================================================================
    testNum = "5164"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.filePathExoprtedQuizAnswersAfterClearingAttempts = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + "/quiz_answers.csv"
            ...
            self.filePathExoprtedQuizAnswersAfterRetakingQuiz = localSettings.LOCAL_SETTINGS_JENKINS_NODE_SHARED_DOWNLOAD + "/quiz_answers(1).csv"
            ...
            if self.common.compareBetweenTwoCsvFiles(self.filePathExoprtedQuizAnswersAfterClearingAttempts, self.filePathQuizAnswersAfterClearingAttempts)  == False:
                self.status = "Fail"
            ...
            i = i + 1 
            writeToLog("INFO","Step " + str(i) + " : Going to verify that quiz questions csv files is download correctly")  
            if self.common.compareBetweenTwoCsvFiles(self.filePathExoprtedQuizAnswersAfterRetakingQuiz, self.filePathQuizAnswersAfterRetakingQuiz)  == False:
                self.status = "Fail"
                writeToLog("INFO","Step " + str(i) + " : FAILED to verify that quiz questions csv files is download correctly")  
                return                                                                                                         
