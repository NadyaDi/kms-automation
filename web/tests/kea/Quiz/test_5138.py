...
class Test:
    ...
    # Test Name : Quiz - Analytics - Export quiz question - Allow multiple attempts is disabled
    # Test description:
...
#    answerQuestionNumber4 = 'Viewed'
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 21 : Going to navigate to quiz questions tab")  
            if self.common.entryPage.navigateToQuizAnalyticsPage(self.quizEntryName, True, enums.quizAnalytics.QUIZ_QUESTIONS)  == False:
                self.status = "Fail"
                writeToLog("INFO","Step 21 : FAILED to navigate to quiz questions tab")  
                return                                             
