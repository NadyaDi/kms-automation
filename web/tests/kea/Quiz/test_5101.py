...
class Test:
    ...
    # Test Name : Quiz - Retake quiz - Lowest score type
    # Test description:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName = clsTestService.addGuidToString("Retake 3 Attempts Lowest score", self.testNum)
            self.quizEntryName = clsTestService.addGuidToString("Retake 3 Attempts Lowest score - Quiz", self.testNum)  
            ...
            if self.common.player.verifyQuizAttempts(self.quizQuestionsDictAllAttempts, expectedQuizScore=self.quizSpecificAttemptScore, totalGivenAttempts=self.totalGivenAttempts, expectedAttemptGeneralScore=self.quizGeneralAttemptsScore, scoreType=enums.playerQuizScoreType.LOWEST) == False:
                self.status = "Fail"
            ...
            ##################################################################
            self.status = "Pass"
            writeToLog("INFO","TEST PASSED: Retake quiz - based on Lowest score was created and answered successfully")
