...
class Test:
    ...
    # Test Name : Quiz - Retake quiz - Disable show score
    # Test description:
    # Go to editor page and create quiz with option to retake quiz - 3 attempts and disable show score
    # Go to quiz page and verify that user is able to retake quiz 3 times and score isn't displayed in submitted screen
    #================================================================================================================================
    testNum = "5106"
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.entryName = clsTestService.addGuidToString("Retake - Disable show score", self.testNum)
            self.quizEntryName = clsTestService.addGuidToString("Retake - Disable show score - Quiz", self.testNum)  
            ...
            self.KeaDisableShowScore             = {enums.KEAQuizOptions.DO_NOT_SHOW_SCORES:True}
            
            self.keaScoreOptions                 = [self.keaAllowMultipleScore, self.keaNumberOfAllowedAttempts, self.keaScoreType, self.KeaDisableShowScore]
            ...
            if self.common.player.verifyQuizAttempts(self.quizQuestionsDictAllAttempts, expectedQuizScore=self.quizSpecificAttemptScore, totalGivenAttempts=self.totalGivenAttempts, expectedAttemptGeneralScore=self.quizGeneralAttemptsScore, scoreType=enums.playerQuizScoreType.AVERAGE, showScore=False) == False:
                self.status = "Fail"
            ...
            ##################################################################
            self.status = "Pass"
            writeToLog("INFO","TEST PASSED: Retake quiz - disable show score was created and answered successfully")
