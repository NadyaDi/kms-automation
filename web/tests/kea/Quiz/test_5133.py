...
class Test:
    ...
    # Go to quiz page with different user and answer quiz, take all attempts-> Login with quiz owner -> Quiz analytics page -> Clear all attempts -> 
    ...
    quizQuestionsDictAttemptsAfterClearingAllAttempts = [quizQuestionDictAttempt1, quizQuestionDictAttempt2]
    quizSpecificAttemptScoreAfterClearingAllAttempts = [specificScoreAttempt1, specificScoreAttempt2]
    quizGeneralAttemptsScoreAfterClearingAllAttempts = [generalScoreAttempt1, generalScoreAttempt2]
