...
class Test:
    ...
    # Test Name : Recscheduling - Create new recurring event - Daily - Every weekday
    # Test description:
    ...
    startEventTime = None
    endTime = None
    numberOfDaysForEvent = 9
    numberOfRecurrence = 7
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            self.eventTitle = clsTestService.addGuidToString("recurring event-Daily-Every weekday", self.testNum)
            ...
            self.endDate = (datetime.datetime.now() + timedelta(days=self.numberOfDaysForEvent)).strftime("%d/%m/%Y")
            ...
            self.event.dailyOption =  enums.scheduleRecurrenceDailyOption.EVERY_WEEKDAY
