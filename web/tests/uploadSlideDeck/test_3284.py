...
class Test:
    ...
    # Test Name : Slide Deck Upload-  search slides
    # Test description:
...
#             self.slidesWithName = [('second slide','00:02'),('fifth slide','00:05'), ('eighth slide','00:08')]
            # Removed the 'eighth slide' search due to unstable test
            self.slidesWithName = [('second slide','00:02'),('fifth slide','00:05')]
            ...
            index = 0
            writeToLog("INFO","Step 9: Going to check 4 slide (slide from the start / 2 in the middle / end of the video) and see that they appear at the correct time and did not deleted with the chapter")
            for i in range(2):
                sleep(2)
                index = index + i + 4 
