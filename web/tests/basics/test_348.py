...
class Test:
    ...
    def test_01(self,driverFix,env):
        ...
        try:
            ...
            writeToLog("INFO","Step 8: Going to remove added caption with added as Collaborator user")
            if self.common.editEntryPage.removeCaption(self.captionLabel) == False:
                self.status = "Fail"
                writeToLog("INFO","Step 8: FAILED to remove added caption to entry '" + self.entryName + "' with Collaborator user")
                return
