...
class clsBrowserMobCapture:
    ...
    def __init__(self,testNum,testBrowser):
            ...
            self.harPath = os.path.abspath(os.path.join(localSettings.LOCAL_SETTINGS_KMS_WEB_DIR,'logs' + LOG_FOLDER_PREFIX + "/" + str(runningTestNum) + "/","test_" + runningTestNum + "_" + self.testBrowser + '.har'))
