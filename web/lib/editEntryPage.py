...
class EditEntryPage(Base):
    ...
    EDIT_ENTRY_THUMBNAIL_TAB                                    = ('id', 'Thumbnails-tab')
    EDIT_ENTRY_CAPTION_TAB                                      = ('id', 'Captions-tab')
    EDIT_ENTRY_DOWNLOADS_TAB                                    = ('id', 'Downloads-tab')
    EDIT_ENTRY_TIMELINE_TAB                                     = ('id', 'Timeline-tab')
    ...
    EDIT_ENTRY_REPLACE_VIDEO_TAB                                = ('xpath', '//a[@id="ReplaceVideo-tab"]')
    ...
    EDIT_ENTRY_ATTACHMENTS_TAB                                  = ('xpath', '//a[@id="Attachments-tab"]')
